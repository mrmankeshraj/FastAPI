...
def test_delete_vote_post_non_exist(authorized_client, test_posts, test_vote):
    res = authorized_client.post("/vote/", json={"post_id": 999800, "dir": 1})
    assert res.status_code == 404

def test_vote_unaothorized_user(client, test_posts):
